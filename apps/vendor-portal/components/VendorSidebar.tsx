...
import { useVendorAuth } from './VendorAuthProvider';

const NAV_ITEMS = [
  { href: '/dashboard', label: 'Dashboard', icon: '📊' },
  { href: '/venue', label: 'My Venue', icon: '🏛️' },
      ...
      <div className="px-5 py-5 border-b border-white/[0.06]">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span className="block text-[9px] text-ink-faint tracking-[0.2em] font-semibold">VENUE PORTAL</span>
          </div>
        </div>
      </div>
